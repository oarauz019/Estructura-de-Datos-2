...
public class MenuLogica {
    ...
    public void menu() {
        ...
        do {
            ...
            System.out.println("2. Consulta de Bitácora de Citas del Día");
            System.out.println("3. Consulta de Expediente Único de Pacientes");
            System.out.println("4. Chat Bot de atención de consultas"); // Nueva opción del chatbot
            System.out.println("5. Ayuda e Información");
            ...
            switch (opcion) {
                case 1:
                    System.out.println("Accediendo a la Gestión de Pacientes...");
                    gestionPacientes.SubMenuGestionPacientes(); // Llama al submenú de gestión de pacientes.
                    break;
                case 2:
                    System.out.println("Accediendo a la Bitácora de Citas del Día...");
