...
public class GestionPacientes {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Volviendo al menú principal del programa...");
    ...
    private void escogerFichaPaciente(Scanner scanner) {
        System.out.println("\n--- Selección de Ficha ---");
        System.out.println("Escoja la categoría apropiada de ficha:");
        ...
        if (categoria == 1) {
            ...
            System.out.println("Categoría de ficha no válida. El paciente no fue encolado.");
            return; // Sale del método si la categoría no es válida.
        }

        System.out.println("Su número de ficha es: " + fichaAsignada);
    ...
    private void atencionDePacientes(Scanner scanner) {
        ...
        if (pacienteAtendido != null) {
            ...
            if (expedienteActual == null) {
                ...
                System.out.print("Ingrese el género del paciente (Ej. Masculino, Femenino, Otro): ");
            ...
            System.out.print("Ingrese el diagnóstico (texto abierto): ");
            ...
            System.out.println("Cita añadida a la bitácora del día.");
    ...
    private void mostrarFichasPendientes() {
        System.out.println("\n--- Fichas Pendientes ---");
        System.out.println("Fichas sin atender en la categoría REGULAR:");
        c_Regular.imprimirCola();

        System.out.println("\nFichas sin atender en la categoría PREFERENCIAL:");
    ...
    private void abandonarCola(Scanner scanner) {
        System.out.println("\n--- Abandonar Cola ---");
        System.out.print("Indique el número de ficha para abandonar la cola: ");
        ...
        if (pacienteAbandonando != null) {
            System.out.println("Ficha #" + pacienteAbandonando.getFicha() + " con cédula " + pacienteAbandonando.getCedula() + " ha abandonado la cola sin ser atendido/a.");

            // Registra una queja por el abandono de la cola.
            Queja queja = new Queja(new Date(), "Paciente abandonó la cola sin ser atendido.", pacienteAbandonando.getNombre(), pacienteAbandonando.getCedula());
            pilaQuejas.apilar(queja);
            System.out.println("Se ha registrado una queja por el abandono.");
        } else {
            System.out.println("Ficha no localizada en ninguna de las colas. Por favor, verifique el número.");
        }
    }
    ...
    protected void consultarBitacoraCitasDia() {
        ...
        if (bitacoraCitasDia.estaVacia()) {
            System.out.println("No hay citas registradas en la bitácora del día.");
            return;
        }
    ...
    protected void consultarExpedienteUnicoPacientes(Scanner scanner) {
        ...
        do {
            System.out.println("\n--- Expediente Actual ---");
            System.out.println("Cédula: " + actual.getDato().getCedula());
            System.out.println("Nombre: " + actual.getDato().getNombre());
            System.out.println("Edad: " + actual.getDato().getEdad());
            System.out.println("Género: " + actual.getDato().getGenero());
            ...
            System.out.println("\nNavegación (N: Siguiente, P: Anterior, S: Salir):");
