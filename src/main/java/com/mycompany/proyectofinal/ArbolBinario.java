...
class ArbolBinario {
    ...
    public void insertar(String codigoPadre, String nombreNodo) {
        if (raiz == null) {
            if (codigoPadre.equals("1")) {
                ...
                System.out.println("Nodo raiz '1' creado con exito.");
            } else {
                System.out.println("Error: La raiz debe ser '1'.");
            }
            return;
        }
        ...
        if (padre == null) {
            System.out.println("Error: No se encontro el nodo padre con codigo " + codigoPadre);
            return;
        }
        ...
        if (padre.izquierda == null) {
            ...
            System.out.println("Nuevo nodo " + nuevoCodigo + " insertado con exito.");
        } else {
    ...
    public void modificarNodo(String codigo, String nuevoNombre) {
        ...
        if (nodo != null) {
            ...
            System.out.println("Nodo con codigo " + codigo + " modificado con exito.");
        } else {
            System.out.println("Error: Nodo con codigo " + codigo + " no encontrado.");
        }
    }
    ...
    public void eliminarNodo(String codigo) {
        if (raiz == null) {
            System.out.println("Error: El arbol está vacio.");
            return;
        }
        if (raiz.codigo.equals(codigo)) {
            System.out.println("Error: No se puede eliminar la raiz.");
            return;
        }
        ...
        if (padre != null) {
            ...
            System.out.println("Nodo con codigo " + codigo + " eliminado con exito.");
        }
    }
    ...
    public void preCargarArbol() {
        ...
        // Nivel 4
        NodoArbol nodo1111 = new NodoArbol("1111", "Mayores 18 anios");
        ...
        nodo1111.listaPreguntas.agregar("Cual es el costo de consulta para adultos?", "El costo de atencion en emergencias para un adulto es de 20,000 colones.");
        nodo1111.listaPreguntas.agregar("Cual es el tiempo promedio de espera?", "Por tratarse de un servicio de emergencia no podemos garantizar un tiempo minimo para atenciones menores. Sin embargo, en promedio demoramos 30 minutos.");

        // Nodo 1112
        nodo1112.listaPreguntas = new ListaEnlazada();
        nodo1112.listaPreguntas.agregar("Que especialidad atiende a los ninos?", "Contamos con pediatra las 24 horas del dia.");
        nodo1112.listaPreguntas.agregar("Se puede aplicar el seguro estudiantil?", "Sí, recibimos todos los seguros medicos del mercado.");
        ...
        nodo112.listaPreguntas.agregar("Horario", "Atendemos 24 horas del dia.");
        nodo112.listaPreguntas.agregar("Sucursales", "Tenemos sucursales en todo el pais, ingrese a www.susalud.com/sucursales para mayor informacion.");
        ...
        nodo1211.listaPreguntas.agregar("Que tipo de examenes de laboratorio realizan?", "Realizamos examenes de sangre, orina, heces y otros estudios especializados.");
        nodo1211.listaPreguntas.agregar("Necesito una cita previa para examenes de laboratorio?", "Para la mayoria de los examenes no es necesario. Para estudios especializados, por favor, consulte la pagina web o llame a nuestra central telefonica.");

        // Nodo 1212 (Farmacia)
        nodo1212.listaPreguntas = new ListaEnlazada();
        nodo1212.listaPreguntas.agregar("Tienen servicio a domicilio?", "Si, contamos con servicio de entrega a domicilio con un costo adicional.");
        nodo1212.listaPreguntas.agregar("Cual es el horario de la farmacia?", "Nuestra farmacia esta abierta las 24 horas del dia, los 7 dias de la semana.");
    }
}
