...
class ListaEnlazada {
    ...
    public void agregar(String nombre, String respuesta) {
        ...
        System.out.println("Pregunta agregada con exito.");
    }
    ...
    public void modificar(int codigo, String nuevoNombre, String nuevaRespuesta) {
        ...
        if (p != null) {
            ...
            System.out.println("Pregunta modificada con exito.");
        } else {
            System.out.println("Error: Pregunta con codigo " + codigo + " no encontrada.");
        }
    }
    ...
    public void eliminar(int codigo) {
        if (cabeza == null) {
            System.out.println("Error: La lista de preguntas esta vacia.");
            return;
        }

        if (Integer.parseInt(cabeza.pregunta.codigoPregunta) == codigo) {
            cabeza = cabeza.siguiente;
            System.out.println("Pregunta eliminada con exito.");
            return;
        }
